function addProduct(){
    ...
    let input_product_name = document.getElementById("input_bar").value;
    ...
    if(unique && input_product_name != "") {
        ...
        newMinusProduct.dataset.tooltip = "Зменшити кількість одиниць продукту";
        ...
        newPlusProduct.dataset.tooltip = "Збільшити кількість одиниць продукту";
        ...
        newBoughtButton.dataset.tooltip = "Наразі товар у категорії 'Залишилося'";
        ...
        newCancel.dataset.tooltip = "Скасувати дію";
        ...
        document.getElementById("input_bar").focus();
        ...
        let leftBox = document.getElementById("left_products");
...
function buy(button){
    ...
    button.dataset.tooltip = "Наразі товар у категорії 'Куплено'";
...
function unBuy(button){
    ...
    let statBox = document.getElementById("product_basket");
    let productStats = statBox.getElementsByClassName("basket_product");
    let left = document.getElementById("left_products");
    for(let i= 0; i<productStats.length; i++){
        let productName = productStats[i].getElementsByClassName("basket_product_name");
        if (productName[0].innerText === name[0].innerText){
